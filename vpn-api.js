...
const TunnelAPI = {
  vmess: '/opt/vpn-api/TunnelAPI/createvmess.sh',
  ssh: '/opt/vpn-api/TunnelAPI/createssh.sh',
  vless: '/opt/vpn-api/TunnelAPI/createvless.sh',
  trojan: '/opt/vpn-api/TunnelAPI/createtrojan.sh',
  renewvmess: '/opt/vpn-api/TunnelAPI/renewvmess.sh',
  renewvless: '/opt/vpn-api/TunnelAPI/renewvless.sh',
  renewtrojan: '/opt/vpn-api/TunnelAPI/renewtrojan.sh',
  renewssh: '/opt/vpn-api/TunnelAPI/renewssh.sh',
  cekuserssh: '/opt/vpn-api/TunnelAPI/cekuserssh.sh',
  cekusertrojan: '/opt/vpn-api/TunnelAPI/cekusertrojan.sh',
  cekuservless: '/opt/vpn-api/TunnelAPI/cekuservless.sh',
  cekuservmess: '/opt/vpn-api/TunnelAPI/cekuservmess.sh',
  deletessh: '/opt/vpn-api/TunnelAPI/deletessh.sh',
  deletevmess: '/opt/vpn-api/TunnelAPI/deletevmess.sh',
  deletevless: '/opt/vpn-api/TunnelAPI/deletevless.sh',
  deletetrojan: '/opt/vpn-api/TunnelAPI/deletetrojan.sh',
  backupserver: '/opt/vpn-api/TunnelAPI/backupserver.sh',
  restoreserver: '/opt/vpn-api/TunnelAPI/restoreserver.sh'
};
...
app.get('/backupserver', (req, res) => {
  ...
  execFile(TunnelAPI.backupserver, {
    signal,
    env: {
      ...process.env,
      REQUEST_METHOD: 'GET',
...
app.get('/restoreserver', (req, res) => {
  ...
  execFile(TunnelAPI.restoreserver, {
    signal,
    env: {
      ...process.env,
      REQUEST_METHOD: 'GET',
...
app.get('/health', (req, res) => {
  res.json({
    status: 'healthy',
    services: Object.keys(TunnelAPI),
